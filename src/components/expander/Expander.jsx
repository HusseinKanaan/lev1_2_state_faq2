    ...
    return (
        <section>
            ...
            <article className='question'>
                ...
                <button onClick={expand}>{!big ? '+' : '-' }</button>
            </article>

            <article className='answer' style={!big ? { display: 'none' } : { display: 'Block' }}>
                <p>Fast Learning Curve</p>
                <button onClick={expands}>{!bigger ? '+' : '-'}</button>
            </article>

            <article className='longanswer' style={!bigger ? { display: 'none' } : { display: 'Block' }}>
                <p>
